  ...
  accounts: [
    {
      ...
      platform: '小红书',
      name: '有鹿招聘研究所',
      externalId: 'xhs-real-account-001',
      integrationId: 'mvp-integration-platform',
      provider: '小红书指标拉取',
      profileUrl: 'https://example.com/xhs/account/001',
      followerCount: 12800,
      status: '已连接',
    ...
    },
    {
      ...
      platform: '脉脉',
      name: '技术招聘伙伴',
      externalId: 'maimai-real-account-002',
      integrationId: 'mvp-integration-maimai',
      provider: '脉脉指标拉取',
      profileUrl: 'https://example.com/maimai/account/002',
      followerCount: 8600,
      status: '已连接',
      syncedAt: '2026-05-26 10:00',
    },
    {
      ...
      platform: 'B站',
      name: '有鹿技术团队',
      externalId: 'bilibili-real-account-003',
      integrationId: 'mvp-integration-bilibili',
      provider: 'B站指标拉取',
      profileUrl: 'https://example.com/bilibili/account/003',
      followerCount: 4300,
      status: '已连接',
      syncedAt: '2026-05-26 10:00',
    },
